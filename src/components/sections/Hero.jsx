...
const Hero = () => {
  ...
  useEffect(() => {
    ...
    return () => window.removeEventListener("scroll", throttledHandleParallax);
  }, []);
  ...
  return (
    <section
      id="home"
      ref={heroRef}
      className="relative top-16 min-h-screen flex items-center pt-8 justify-center overflow-hidden parallax"
    >
      {/* Animated Background */}
        ...
        <div className="flex flex-col-reverse md:flex-row items-center">
          ...
          <div className="md:w-1/2 flex justify-center">
            ...
            >
              ...
              >
                <div className="w-48 h-48 md:w-60 md:h-60 rounded-full !bg-white overflow-hidden flex items-center justify-center relative">
                  <Image
                    src={mainImage}
                    alt="Construction"
                    fill
              ...
              <div className="p-6 h-full flex flex-col">
                ...
                <div className="space-y-8 flex-1 overflow-y-auto pr-2">
                  ...
                  >
                    ...
                    >
                      Have a project in mind? Reach out to our team for a
                      consultation.
                    </p>
                    <Button
                      href="#contact"
